<?php
//dodavanja veterinarskih stranica
...
$path= "php/veterinarske_stanice/".$slika;
...
if(isset($_FILES['image'])){
    ...
    //putanja
    $uploads_dir = "veterinarske_stanice/";
...
//
$sql = "INSERT INTO veterinarske_stanice (naziv, mesto, adresa, telefon, email, opis, slika) VALUES ('$naziv', '$mesto','$adresa','$telefon', '$email','$opis','$path')";
